---
title: "Polymer at a Glance"
description: "Steps involved in end-to-end application flow"
---
...
```mermaid
graph LR
    A[App Emits Event] --> B[Request Proof via API]
    B --> C[Poll for Proof Result]
    C --> D[Submit to Validator Contract]
    D --> E[Get Validated Event Data]
```
