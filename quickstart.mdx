...
<Card title="Configure your global settings" icon="settings" href="essentials/settings" horizontal>
...
<Card title="Organize navigation" icon="map" href="essentials/navigation" horizontal>
